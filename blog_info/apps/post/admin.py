...
from apps.post.models import Post, PostImage, Comment, Category # importo todos mis modelos

# Register your models here.

class PostAdmin(admin.ModelAdmin): 
    list_display = ('title', 'author', 'category', 'creation_date', 'modification_date', 'allow_comment')  # Campos a mostrar en la lista 
    ...
    list_filter = ('category', 'author', 'creation_date', 'allow_comment') 
...
class PostImageAdmin(admin.ModelAdmin): 
    list_display = ('post', 'image','create_date', 'active')  # Campos a mostrar en la lista 
